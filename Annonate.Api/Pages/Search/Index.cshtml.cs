...
namespace Annonate.Api.Pages.Search;
...
public class IndexModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetSearchAsync([FromQuery] string query)
    {
        ...
        {
            return new JsonResult(ApiResponse<object>.SuccessResponse(new
            {
        ...
        return new JsonResult(ApiResponse<object>.SuccessResponse(results));
    }
}
